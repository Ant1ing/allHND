...
<body>
    <hr class="psBlue">
    <header> <a href="index.php"><img src="images/ps_logo.png" alt="Perfecto Logo" class="logo"></a>
    ...
    <main class="content">
        <section class="registerSection">
            ...
            <div class="registerForm">
                <form class="registerForm" action="insertUser.php" method="post">
                    <input type="text" name="FirstName" placeholder="First Name" required class="formField">
                    <input type="text" name="LastName" placeholder="Last Name" required class="formField">
